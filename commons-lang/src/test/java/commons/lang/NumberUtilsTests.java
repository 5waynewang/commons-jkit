...
public class NumberUtilsTests {
	...
	public void testTruncate() {
		Assert.assertEquals(NumberUtils.truncate(234.678), 234.0, 0);
		Assert.assertEquals(NumberUtils.truncate(234.678, 1), 234.6, 0);
		Assert.assertEquals(NumberUtils.truncate(234.678, 2), 234.67, 0);
		Assert.assertEquals(NumberUtils.truncate(234.678, -1), 230.0, 0);
		Assert.assertEquals(NumberUtils.truncate(234.678, -2), 200.0, 0);
		Assert.assertEquals(NumberUtils.truncate(-234.678), -234.0, 0);
		Assert.assertEquals(NumberUtils.truncate(-234.678, 1), -234.6, 0);
		Assert.assertEquals(NumberUtils.truncate(-234.678, 2), -234.67, 0);
		Assert.assertEquals(NumberUtils.truncate(-234.678, -1), -230.0, 0);
	...
	public void testRound() {
		Assert.assertEquals(NumberUtils.round(2.67, 0), 3.0, 0);
		Assert.assertEquals(NumberUtils.round(2.45, 0), 2.0, 0);
		Assert.assertEquals(NumberUtils.round(2, 0), 2.0, 0);
		Assert.assertEquals(NumberUtils.round(2.45, 1), 2.5, 0);
		Assert.assertEquals(NumberUtils.round(2.44, 1), 2.4, 0);
		Assert.assertEquals(NumberUtils.round(2.44, 2), 2.44, 0);
		Assert.assertEquals(NumberUtils.round(2.44, 3), 2.44, 0);
		Assert.assertEquals(NumberUtils.round(-2.44, 3), -2.44, 0);
		Assert.assertEquals(NumberUtils.round(2.4467, 3), 2.447, 0);
		Assert.assertEquals(NumberUtils.round(-2.4467, 3), -2.447, 0);
		Assert.assertEquals(NumberUtils.round(2.45, -1), 0.0, 0);
		Assert.assertEquals(NumberUtils.round(12.45, -1), 10.0, 0);
		Assert.assertEquals(NumberUtils.round(252.45, -2), 300.0, 0);
		Assert.assertEquals(NumberUtils.round(-252.45, -2), -300.0, 0);
		Assert.assertEquals(NumberUtils.round(-252.45, -1), -250.0, 0);
		Assert.assertEquals(NumberUtils.round(-2552.45, -1), -2550.0, 0);
		Assert.assertEquals(NumberUtils.round(672552.45, -5), 700000.0, 0);
		Assert.assertEquals(NumberUtils.round(672552.45, -6), 1000000.0, 0);
	}
	...
	public void testEncode() {
		...
		System.out.println(Long.toBinaryString(200));
	}
